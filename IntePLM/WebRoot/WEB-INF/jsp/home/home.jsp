...
<html>
<head>
    <title>东风柳汽IntePLM系统</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <link href="${ctx}/css/home.css" rel="stylesheet" type="text/css" />
    <link rel="icon" href="${ctx}/images/home/favicon.ico"> <link> 
</head>
...
<div class="menu">
    <ul class="clearfix">
        ...
        <li><a href="${ctx }/nsfw/home_frame.action">机构管理</a> </li>
...
<!-- 尾部{ -->
<div class="foot">版权所有©武汉天喻软件2017</div>
<!-- }尾部 -->
</body>
</html>