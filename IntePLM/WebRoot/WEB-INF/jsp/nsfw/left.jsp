    ...
    <div class="xzfw_nav" style="width:214px;min-height:500px;">
        <div class="nBox" style="width:214px;">
            ...
            <div class="sm">
                ...
                <dl>
                    <dt><a class="xxfb" href="${ctx }nsfw/info_listUI.action" target="mainFrame"><b></b>文档规则管理<s
                            class="down"></s> </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="tssl" href="${ctx }nsfw/complain_listUI.action" target="mainFrame"><b></b>工程单类型管理<s
                            class="down"></s> </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="nszx" href="#" target="mainFrame"><b></b>流程模板管理<s class="down"></s> </a></dt>
                </dl>

                <dl class="">
                    <dt><a class="fwdc" href="#" target="mainFrame"><b></b>生命周期管理<s class="down"></s> </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="ygz" href="#" target="mainFrame"><b></b>属性集管理<s class="down"></s> </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="fwyy" style="cursor: pointer;"><b></b>权限管理<s class="down"></s> </a></dt>
                    <dd id="fwyygl" style="display:none;">
                        <a class="" href="#" target="mainFrame"><b></b>系统权限管理</a>
                        <a class="" href="#" target="mainFrame"><b></b>权限规则定义</a>
                    </dd>
                </dl>
            </div>
        </div>
